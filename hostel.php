        ...
        <div class="container d-flex align-items-stretch">
          ...
          <nav id="navbar" class="sidenav">
            <ul class="list-unstyled components mb-5">
              <li class="active">
                <a href="#"><span class="fa fa-chevron-right mr-3"></span> Students List</a>
              </li>
              <li>
...
<div class="container">
<header><h1 align="center">Welcome <?php print($_SESSION['name']);?></h1></header>
  ...
  <table class='table table-secondary text-center'>
      ...
      <?php
        ...
        $hostel= $_SESSION['name'];
         $query = "SELECT id,name,birthday,gender,hostel,mail FROM `students` WHERE hostel='$hostel'";
        ...
        <td><a href="hosteledit.php?id=<?php echo $row["id"]; ?>" data-toggle="tooltip" title="Edit"> <i class="fa fa-edit" style="font-size:30px;color:black"></i></a></td>
                        <td><a href="hosteldelete.php?id=<?php echo $row["id"]; ?>"  onclick="myFunction()" data-toggle="tooltip" title="Delete"><i class="fa fa-trash-o" style="font-size:30px;color:black"></i></a>
