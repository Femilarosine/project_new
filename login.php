...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $sql="select * from students where name ='".$username."' AND mail='".$password."'";
            ...
            <div class="wrap-login100">
                <form class="login100-form validate-form" name="f1" action = "#" onsubmit = "return validation()" method = "POST">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Enter password">
                        <input class="input100" type="password" name="mail" placeholder="Enter the email">
                        <span class="focus-input100" data-placeholder="&#xf191;"></span>
                    </div>
                    ...
                    <div class="container-login100-form-btn">
                        ...
                        <button class="login100-form-btn">
                            ...
                            <a class="nav-link scrollto login100-form-btn text-center" href="inlogin.php">Incharge login</a>
</div>
